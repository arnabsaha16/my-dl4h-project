...
def batch_by_size(
    ...
    # Force int64 dtype for both indices and num_tokens_vec, regardless of current type
    ...
    if num_tokens_vec is not None:
        num_tokens_vec = np.asarray(num_tokens_vec, dtype=np.int64)
        
    # Optional debug prints to confirm at runtime
    print("DEBUG: indices dtype =", indices.dtype)
    if num_tokens_vec is not None:
        print("DEBUG: num_tokens_vec dtype =", num_tokens_vec.dtype)
